...
![train_tf](./img/train_tf.JPG){: width="5" height="5"}
## Bleu score on devset with Transformer
![bleu_tf](./img/bleu_tf.JPG){: width="5" height="5"}

## Training Loss Curve with Transformer
![train_rnn](./img/train_rnn.JPG){: width="5" height="5"}
## Bleu score on devset with Transformer
![bleu_rnn](./img/bleu_rnn.JPG){: width="5" height="5"}
